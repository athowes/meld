...
### Distributed Data Monte Carlo

* @dai2019monte targets $f(x) \propto f_{1}(x) \cdots f_{C}(x)$ where each of $f_{c}(x)$ is proportional to a density representing one of the $C$ distributed inferences to be unified
* @scott2016bayes introduces Consensus Monte Carlo
