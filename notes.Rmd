...
*Informal: almost like Bayesian inference for full model with likelihood squared (not quite)*

## 4.2. Monte Carlo scheme

### 4.2.1 Metropolis-within-Gibbs

Continue to use (symmetric) normal proposals throughout.

To update first latent parameter $\psi_1$ use systematic scan Metropolis-within-Gibbs.
