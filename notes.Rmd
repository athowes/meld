...
* Product of Experts (special case of logarithmic pooling) $f(\theta) \propto \prod_{i=1}^{n} f_i(\theta)$
...
## 1.3. ([Smith 2010](#ref)) Chapter 7: Bayesian networks

### 1.3.1. Relevance, informativeness and independence
...
* More to-do here, look at some work of Pearl?

### 1.3.2. Bayesian networks and DAGs
...
# 3. ([Lindsten et al. 2017](#ref)) D&C-SMC
