...
### 1.1.1. Metropolis-Hastings sampler
...
### 1.1.2. (Random scan) Gibbs sampler
...
### 1.1.3. (Random scan) Metropolis-within-Gibbs
...
## 1.2. Meta-analysis, evidence synthesis, combining expert opinion etc.

### 1.2.1 ([O'Hagan 2006](#ref)) Chapter 9: Multiple Experts
...
* Cooke's method
* For more about opinion pooling, could look at ([Clemen, 1999](#ref)

## 1.3. Graphical models
### 1.3.1 ([Smith, 2010](#ref)) Chapter 7: Bayesian networks

#### 1.3.1.1 Relevance, informativeness and independence
...
#### 1.3.1.2. Bayesian networks and DAGs
...
## 1.4. Misc. reading
### 1.4.1. ([Spiegelhalter, 1995](#ref)) Bayesian approaches to random-effects meta-analysis
...
* Use Gibbs sampling (BUGS) to perform inference

![*To-do: reproduce this and similar models in Tikz* Solid line is stochastic dependence, dashed line is logical dependence](images/graphical_model.png)

### 1.4.2. ([Fleiss, 1993](#ref)) The statistical basis of meta-analysis
...
### 1.4.3. ([Kennedy, 2001](#ref)) Bayesian calibration of computer models
...
### 1.4.4. ([Poole, 2000](#ref)) Inference for deterministic simulation models: the Bayesian melding approach
# 2. ([Goudie, 2018](#ref)) Markov Melding

## 2.1. Introduction to Markov melding
...
## 2.2. Markov combination

*To-do: add references to Dawid, Massa*
...
## 2.3. Pooling marginal distributions
...
### 2.4.2. Multi-stage Metropolis-within-Gibbs
...
### 4.3.2 Multi-stage Metropolis-within-Gibbs
...
* Lindsten, F., Johansen, A. M., Naesseth, C. A., Kirkpatrick, B., Schon, T. B., Aston, J. A. D., & Bouchard-Cote, A. (2017). Divide-and-conquer with sequential Monte Carlo. Journal of Computational and Graphical Statistics, 26(2), 445-458.
