...
In Chapter \ref{chapter:comp} we discuss computational methods for conducting inference on this model, applying these methods to synthesising multiple meta-analysis
